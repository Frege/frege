...
// $Rev: 179 $
// $Id: Product4.java 179 2011-02-18 12:44:14Z ingo $
/**
 ...
 * </p>
 *
 * <p> Note that Product<sub><em>4</em></sub> is not a subclass of Product<sub><em>3</em></sub>! </p>
 */
public abstract class Product4<T1,T2,T3,T4> implements Value {
    ...
    public final static class Get1<T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            extends Fun1<T, T1> {
        ...
        public final static <T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            Get1<T1,T2,T3,T4,T> n() {
                return (Get1<T1,T2,T3,T4,T>) single;
        }
    }
    /** <p>Field 2 </p> */
    public final Lazy<T2> m2;
    /** <p> Frege function to get field 2 lazily. </p> */
    public final static class Get2<T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            extends Fun1<T, T2> {
        ...
        @SuppressWarnings("unchecked")
        public final static <T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            Get2<T1,T2,T3,T4,T> n() {
                return (Get2<T1,T2,T3,T4,T>) single;
        }
    }
    /** <p>Field 3 </p> */
    public final Lazy<T3> m3;
    /** <p> Frege function to get field 3 lazily. </p> */
    public final static class Get3<T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            extends Fun1<T, T3> {
        ...
        @SuppressWarnings("unchecked")
        public final static <T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            Get3<T1,T2,T3,T4,T> n() {
                return (Get3<T1,T2,T3,T4,T>) single;
        }
    }
    /** <p>Field 4 </p> */
    public final Lazy<T4> m4;
    /** <p> Frege function to get field 4 lazily. </p> */
    public final static class Get4<T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            extends Fun1<T, T4> {
        ...
        @SuppressWarnings("unchecked")
        public final static <T1,T2,T3,T4, T extends Product4<T1,T2,T3,T4>>
            Get4<T1,T2,T3,T4,T> n() {
                return (Get4<T1,T2,T3,T4,T>) single;
        }
    }
    /** <p> Constructor. </p> */
    protected Product4(final Lazy<T1> arg1,final Lazy<T2> arg2,final Lazy<T3> arg3,final Lazy<T4> arg4) {
        m1 = arg1;
        m2 = arg2;
        m3 = arg3;
        m4 = arg4;
