...
Truly immutable objects are rare in \java{}, so in most cases the \term{pure native} form will not be the appropriate one. A deeper discussion of this matters can be found in \autoref{native interface}.
