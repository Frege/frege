...
%The first form of the package declaration gives an opportunity to use \hyperref[layout]{layout} for the top level by omitting the braces around the \emph{body}. The second form \exq{
%\textbf{package} \emph{packagename}\sym{;} \emph{body}}
l%ooks more \java{}-ish and is equivalent to \exq{
...
\emph{chg...} and \empf{has...} functions can not be mentioned directly by the programmer, 
