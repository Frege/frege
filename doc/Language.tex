...
\emph{packages} or \emph{modules}\footnote{The terms module and package are both used and mean the same in the context of Frege: a named compilation unit}, described in \autoref{modules}.
