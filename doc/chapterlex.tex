...
Documentation text starts with \texttt{/**} and extends to the corresponding \texttt{*/} and line documentation textstarts with  \texttt{///} and extends to the end of the line.
Unlike ordinary comments, documentation texts are tokens and hence are not only lexically but also syntactically relevant.
...
\hasdiff{In \haskell{}, an operator with a lower number binds less tightly.}
...
infixl 3 div            // left associative word operators, 
infixl 3 `mod`          //  backticks don't matter here
infixr 13 `:`           // right associative
infixr 1 `**`           // ditto, but binds tighter than `:`
