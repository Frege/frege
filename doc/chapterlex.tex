...
If some code is commented out using a block comment, then any occurrence of \regex{\{-} or \regex{-\}} within 
a string or within a line comment in that code will interfere with the nested comments.  
...
\\
\hspace{1cm}3rd paragraph of package doc-\}\\
package D where\\
\\
